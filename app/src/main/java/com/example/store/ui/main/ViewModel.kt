                    ...
                    for (element in elements1) {
                        ...
                        itemDao.insert(
                            Item(
                                ...
                                img = doc2.getElementsByClass("b-content")[0].getElementsByClass("l-photo")[0].getElementsByTag(
                                    "img"
                                ).attr("src"),
    ...
    fun setItem(){
        if (filt==0){
           mainItemList= creatItemList
            ...
            mainItemList=creatItemList.filter { it.name.contains(filttext,ignoreCase = true)||(it.producer_name.contains(filttext,ignoreCase = true))||
                    (it.type.contains(filttext,ignoreCase = true))} as MutableList<Item>
        }else{
            mainItemList=creatItemList.filter { (it.price>(filtPrice1.toDouble())) && (it.price<(filtPrice2.toDouble()))} as MutableList<Item>
        }
