...
class MainFragment : Fragment(),ToMainFragment {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerResult.addItemDecoration(DividerItemDecoration(requireContext(), RecyclerView.VERTICAL))
    ...
    override fun onClick(item: Item) {
       ...
       viewModel.addHistory(HistoryItem(item.id, Calendar.getInstance().time.toString(),item.name))
